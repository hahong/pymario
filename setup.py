...
setuptools.setup(
    ...
    packages = packages,
    scripts = scripts,
    url = 'https://github.com/hahong/pymario',
    author = 'Ha Hong',
    author_email = 'anon@anon.com',
    description = 'Python multi-electrode array data IO',
    ...
    license = 'BSD',
    keywords = 'MEA multi-electrode array Blackrock Plexon electrophysiology nev ns5 plx',
